...
class StudentRepositoryTest {
    ...
    @Autowired private static StudentDAO testObject;
    ...
    void setUp() {
        ...
        Student unpersisted = new Student(null, "Simon", "Doe", LocalDate.parse("1990-01-24"));
    ...
    void create() {
        Student student = new Student(
                null, "Jeremy", "John", LocalDate.parse("1980-07-13")
        );
    ...
    @Test
    @DisplayName("Given the lastName findByLastName should return collection of 1")
    void findByLastName() {
